...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  /***/
  function srcAppUserLoginLoginFormLoginFormComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function LoginFormComponent_div_3_p_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function LoginFormComponent_div_3_p_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function LoginFormComponent_div_6_p_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function LoginFormComponent_div_6_p_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function LoginFormComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 5);
    ...
    function () {
      ...
      _createClass(LoginFormComponent, [{
        ...
        value: function onSubmit() {
          ...
          var formData = this.loginForm["controls"];
    ...
    LoginFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 11,
      consts: [["novalidate", "", 3, "formGroup"], [1, "form-group", 3, "ngClass"], ["type", "text", "id", "login", "placeholder", "email", "formControlName", "email", "required", "", 1, "fadeIn"], ["class", "form-control-feedback", 4, "ngIf"], ["type", "text", "name", "login", "id", "password", "placeholder", "password", "formControlName", "password", "required", "", 1, "fadeIn"], [1, "form-control-feedback"], [4, "ngIf"]],
  ...
  function srcAppUserLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(_authService, router, _toastrMessageService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function ngOnInit() {
          ...
          setTimeout(function () {
            _this._toastrMessageService.clearToast();

            _this._toastrMessageService.dismissToastOnClick("Username: 12345@gmail.com, Password: 12345", "Credentials");
          });
        ...
        key: "ngOnDestroy",
        value: function ngOnDestroy() {// this._toastrService.clearToast();
        }
      }, {
        key: "login",
        value: function login() {
          ...
          if (this._authService.isLoggedIn()) {
            ...
            var data = this.model["controls"]; // debugger;

            this._authService.signinUser(data.email.value, data.password.value).subscribe(function (data) {
              if (data.response === 'success') {
                _this2._toastrMessageService.typeSuccess(data.response_message);

                _this2.router.navigate(['pages']);
              }
            }, function (error) {
              _this2._toastrMessageService.typeError(error.error.response_message || error.status_text);
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 0,
      consts: [[1, "wrapper", "fadeInDown"], ["id", "formContent"], [1, "fadeIn"], ["src", "assets/img/login/icon.svg", "id", "icon", "alt", "User Icon"], ["type", "submit", "value", "Log In", 1, "fadeIn", 3, "click"], ["id", "formFooter"], ["routerLink", "/signup", 1, "underlineHover"]],
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_input_click_5_listener($event) {
            return ctx.login();
          });
      ...
      directives: [_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_4__["LoginFormComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLinkWithHref"]],
